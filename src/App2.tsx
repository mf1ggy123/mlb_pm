...
const App: React.FC = () => {
    ...
    useEffect(() => {
        socketRef.current = new WebSocket("wss://684e-18-119-11-201.ngrok-free.app/ws");

        gameStateSocketRef.current = new WebSocket("wss://684e-18-119-11-201.ngrok-free.app/game-state");
